...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (any, error) {
	...
	case "Directory":
		...
		case "NpmInstallDependencies":
			...
			return (*Directory).NpmInstallDependencies(&parent, ctx)
		default:
	...
	case "Npm":
		...
		case "InstallDependencies":
			...
			return (*Npm).InstallDependencies(&parent, ctx, &dir)
		case "":
			var err error
			var typeDefBytes []byte = []byte("{\"asObject\":{\"functions\":[{\"args\":[{\"name\":\"dir\",\"typeDef\":{\"asObject\":{\"functions\":[{\"name\":\"NpmInstallDependencies\",\"returnType\":{\"asObject\":{\"name\":\"Directory\"},\"kind\":\"ObjectKind\"}}],\"name\":\"Directory\"},\"kind\":\"ObjectKind\"}}],\"name\":\"InstallDependencies\",\"returnType\":{\"asObject\":{\"name\":\"Directory\"},\"kind\":\"ObjectKind\"}}],\"name\":\"Npm\"},\"kind\":\"ObjectKind\"}")
