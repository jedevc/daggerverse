...
// The `GithubAssetID` scalar type represents an identifier for an object of type GithubAsset.
type GithubAssetID string
...
func (r *Github) GetLatestRelease(repo string) *GithubRelease {
	q := r.q.Select("getLatestRelease")
	q = q.Arg("repo", repo)
...
func (r *Github) GetRelease(repo string, tag string) *GithubRelease {
	q := r.q.Select("getRelease")
	q = q.Arg("repo", repo)
	q = q.Arg("tag", tag)
...
func (r *GithubAsset) ContentType(ctx context.Context) (string, error) {
	if r.contentType != nil {
		return *r.contentType, nil
	}
	q := r.q.Select("contentType")
...
func (r *GithubAsset) CreatedAt(ctx context.Context) (string, error) {
	if r.createdAt != nil {
		return *r.createdAt, nil
	}
	q := r.q.Select("createdAt")
...
func (r *GithubAsset) DownloadURL(ctx context.Context) (string, error) {
	if r.downloadUrl != nil {
		return *r.downloadUrl, nil
	}
	q := r.q.Select("downloadUrl")
...
// A unique identifier for this GithubAsset.
func (r *GithubAsset) ID(ctx context.Context) (GithubAssetID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.q.Select("id")

	var response GithubAssetID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *GithubAsset) XXX_GraphQLType() string {
	return "GithubAsset"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *GithubAsset) XXX_GraphQLIDType() string {
	return "GithubAssetID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *GithubAsset) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *GithubAsset) MarshalJSON() ([]byte, error) {
	id, err := r.ID(context.Background())
	if err != nil {
		return nil, err
	}
...
func (r *GithubAsset) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadGithubAssetFromID(GithubAssetID(id))
	return nil
}

func (r *GithubAsset) Label(ctx context.Context) (string, error) {
	if r.label != nil {
		return *r.label, nil
	}
	q := r.q.Select("label")
...
func (r *GithubAsset) Name(ctx context.Context) (string, error) {
	if r.name != nil {
		return *r.name, nil
	}
	q := r.q.Select("name")
...
func (r *GithubAsset) Size(ctx context.Context) (int, error) {
	if r.size != nil {
		return *r.size, nil
	}
	q := r.q.Select("size")
...
func (r *GithubAsset) UpdatedAt(ctx context.Context) (string, error) {
	if r.updatedAt != nil {
		return *r.updatedAt, nil
	}
	q := r.q.Select("updatedAt")
...
func (r *GithubAsset) URL(ctx context.Context) (string, error) {
	if r.url != nil {
		return *r.url, nil
	}
	q := r.q.Select("url")
...
func (r *GithubRelease) Assets(ctx context.Context) ([]GithubAsset, error) {
	q := r.q.Select("assets")
	...
	convert := func(fields []assets) []GithubAsset {
		out := []GithubAsset{}

		for i := range fields {
			val := GithubAsset{id: &fields[i].Id}
			val.q = querybuilder.Query().Select("loadGithubAssetFromID").Arg("id", fields[i].Id)
			val.c = r.c
			out = append(out, val)
		}
...
func (r *GithubRelease) Body(ctx context.Context) (string, error) {
	if r.body != nil {
		return *r.body, nil
	}
	q := r.q.Select("body")
...
func (r *GithubRelease) CreatedAt(ctx context.Context) (string, error) {
	if r.createdAt != nil {
		return *r.createdAt, nil
	}
	q := r.q.Select("createdAt")
...
func (r *GithubRelease) UnmarshalJSON(bs []byte) error {
	...
	*r = *dag.LoadGithubReleaseFromID(GithubReleaseID(id))
	return nil
}

func (r *GithubRelease) Name(ctx context.Context) (string, error) {
	if r.name != nil {
		return *r.name, nil
	}
	q := r.q.Select("name")
...
func (r *GithubRelease) PublishedAt(ctx context.Context) (string, error) {
	if r.publishedAt != nil {
		return *r.publishedAt, nil
	}
	q := r.q.Select("publishedAt")
...
func (r *GithubRelease) Repository() *GitRepository {
...
func (r *GithubRelease) Tag(ctx context.Context) (string, error) {
	if r.tag != nil {
		return *r.tag, nil
	}
	q := r.q.Select("tag")
...
func (r *GithubRelease) URL(ctx context.Context) (string, error) {
	if r.url != nil {
		return *r.url, nil
	}
	q := r.q.Select("url")
...
// Load a GithubAsset from its ID.
func (r *Client) LoadGithubAssetFromID(id GithubAssetID) *GithubAsset {
	q := r.q.Select("loadGithubAssetFromID")
	q = q.Arg("id", id)
...
func (r *Client) LoadGithubReleaseFromID(id GithubReleaseID) *GithubRelease {
	q := r.q.Select("loadGithubReleaseFromID")
	q = q.Arg("id", id)
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Hugo":
		...
		case "Build":
			...
			var hugoEnv *string
			if inputArgs["hugoEnv"] != nil {
				err = json.Unmarshal([]byte(inputArgs["hugoEnv"]), &hugoEnv)
				if err != nil {
					panic(fmt.Errorf("%s: %w", "failed to unmarshal input arg hugoEnv", err))
				}
			}
			var minify bool
			if inputArgs["minify"] != nil {
				err = json.Unmarshal([]byte(inputArgs["minify"]), &minify)
				if err != nil {
					panic(fmt.Errorf("%s: %w", "failed to unmarshal input arg minify", err))
				}
			}
			var hugoVersion string
			if inputArgs["hugoVersion"] != nil {
				err = json.Unmarshal([]byte(inputArgs["hugoVersion"]), &hugoVersion)
				if err != nil {
					panic(fmt.Errorf("%s: %w", "failed to unmarshal input arg hugoVersion", err))
				}
			}
			var dartSassVersion string
			if inputArgs["dartSassVersion"] != nil {
				err = json.Unmarshal([]byte(inputArgs["dartSassVersion"]), &dartSassVersion)
				if err != nil {
					panic(fmt.Errorf("%s: %w", "failed to unmarshal input arg dartSassVersion", err))
				}
			}
			return (*Hugo).Build(&parent, ctx, target, baseUrl, hugoEnv, minify, hugoVersion, dartSassVersion)
		default:
				...
				dag.TypeDef().WithObject("Hugo").
					WithFunction(
						dag.Function("Build",
							...
							WithArg("target", dag.TypeDef().WithObject("Directory"), FunctionWithArgOpts{Description: "Directory containing the Hugo site"}).
							WithArg("baseURL", dag.TypeDef().WithKind(StringKind).WithOptional(true).WithOptional(true), FunctionWithArgOpts{Description: "Base URL of the site, overrides from config if set"}).
							WithArg("hugoEnv", dag.TypeDef().WithKind(StringKind).WithOptional(true).WithOptional(true), FunctionWithArgOpts{Description: "Environment to build for"}).
							WithArg("minify", dag.TypeDef().WithKind(BooleanKind).WithOptional(true), FunctionWithArgOpts{Description: "Whether to minify the output, overrides from config if set"}).
							WithArg("hugoVersion", dag.TypeDef().WithKind(StringKind).WithOptional(true), FunctionWithArgOpts{Description: "Version of Hugo to use (defaults to \"latest\")", DefaultValue: JSON("\"latest\"")}).
							WithArg("dartSassVersion", dag.TypeDef().WithKind(StringKind).WithOptional(true), FunctionWithArgOpts{Description: "Version of Dart Sass to use (defaults to \"latest\")", DefaultValue: JSON("\"latest\"")}))), nil
	default:
