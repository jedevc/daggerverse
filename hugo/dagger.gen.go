...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (any, error) {
	...
	case "Directory":
		...
		case "HugoBuild":
			...
			var opt HugoOpt
			err = json.Unmarshal([]byte(inputArgs["opt"]), &opt)
			if err != nil {
				fmt.Println(err.Error())
				os.Exit(2)
			}
			return (*Directory).HugoBuild(&parent, ctx, &opt)
		default:
			return nil, fmt.Errorf("unknown function %s", fnName)
		}
	case "Hugo":
		...
		case "Build":
			...
			return (*Hugo).Build(&parent, ctx, &d, &opt)
		case "":
			var err error
			var typeDefBytes []byte = []byte("{\"asObject\":{\"functions\":[{\"args\":[{\"name\":\"d\",\"typeDef\":{\"asObject\":{\"functions\":[{\"args\":[{\"name\":\"opt\",\"typeDef\":{\"asObject\":{\"fields\":[{\"name\":\"HugoVersion\",\"typeDef\":{\"kind\":\"StringKind\"}},{\"name\":\"DartSassVersion\",\"typeDef\":{\"kind\":\"StringKind\"}},{\"name\":\"BaseURL\",\"typeDef\":{\"kind\":\"StringKind\"}},{\"name\":\"Minify\",\"typeDef\":{\"kind\":\"BooleanKind\"}}],\"name\":\"HugoOpt\"},\"kind\":\"ObjectKind\"}}],\"name\":\"HugoBuild\",\"returnType\":{\"asObject\":{\"name\":\"Directory\"},\"kind\":\"ObjectKind\"}}],\"name\":\"Directory\"},\"kind\":\"ObjectKind\"}},{\"name\":\"opt\",\"typeDef\":{\"asObject\":{\"name\":\"HugoOpt\"},\"kind\":\"ObjectKind\"}}],\"name\":\"Build\",\"returnType\":{\"asObject\":{\"name\":\"Directory\"},\"kind\":\"ObjectKind\"}}],\"name\":\"Hugo\"},\"kind\":\"ObjectKind\"}")
