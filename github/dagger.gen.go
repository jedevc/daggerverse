...
func (r *Release) UnmarshalJSON(bs []byte) error {
	...
	r.URL = concrete.URL
	r.CreatedAt = concrete.CreatedAt
...
func (r *Asset) UnmarshalJSON(bs []byte) error {
	...
	r.Name = concrete.Name
	r.Label = concrete.Label
	r.ContentType = concrete.ContentType
	r.Size = concrete.Size
	r.URL = concrete.URL
	r.DownloadURL = concrete.DownloadURL
	r.CreatedAt = concrete.CreatedAt
	r.UpdatedAt = concrete.UpdatedAt
	return nil
}
